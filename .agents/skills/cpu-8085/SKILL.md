...
Compatible extension of the Intel 8080 (April 1974). Same documented 8080 ops; ten extra ops in 8080 unused cells. **This skill is complete for 8085 work.** 8080-only jobs (no extras) use `cpu-8080` in the z88dk tree — this pack does not ship it.
